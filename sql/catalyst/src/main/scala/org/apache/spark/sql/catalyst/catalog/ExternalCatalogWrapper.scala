 ...
 */
class ExternalCatalogWrapper(override val unwrapped: ExternalCatalog)
  extends ExternalCatalog
  with ListenerBus[ExternalCatalogEventListener, ExternalCatalogEvent] {
  import CatalogTypes.TablePartitionSpec

  protected def delegate: ExternalCatalog = unwrapped
  ...
  override def alterTableStats(
      db: String, table: String, stats: Option[CatalogStatistics]): Unit = {
